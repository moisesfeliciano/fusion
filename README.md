...
Commit: Adicionando no diretório templates da aplicação core os diretórios de
configuração da página index.html

=================================================================

## Adicionando conteúdo da página "index.html":
